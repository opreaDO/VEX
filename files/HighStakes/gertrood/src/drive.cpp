...
Motor leftA(1, MotorGears::ratio_6_to_1);
Motor leftB(2, MotorGears::ratio_6_to_1);
Motor leftC(3, MotorGears::ratio_6_to_1);
Motor rightA(-4, MotorGears::ratio_6_to_1);
Motor rightB(-5, MotorGears::ratio_6_to_1);
Motor rightC(-6, MotorGears::ratio_6_to_1);
MotorGroup leftDrive({1, 2, 3}, MotorGears::ratio_6_to_1);
